...
<section
  id="contact"
  class="relative py-24 overflow-hidden bg-gradient-to-br from-eka-light via-white to-eka-mint"
>
    ...
    <div class="text-center max-w-4xl mx-auto">
      <div class={mounted ? 'animate-fade-in' : ''}>
        <h2 class="text-5xl lg:text-6xl font-bold text-eka-primary-dark mb-12 leading-tight">
          Let's forge regenerative and resilient futures <span class="text-eka-primary"
            >together</span
          >.
        </h2>

        <p class="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
          Building breakthrough technology, scaling into new markets, architecting infrastructure
          for tomorrow's economy? Let's talk.
        </p>
      </div>
      ...
      <div class="mt-20 pt-16 border-t border-gray-200">
        ...
        <div class="flex flex-wrap justify-center gap-8 mb-8">
          <button
            ...
            on:click={() =>
              document.getElementById('our-edge')?.scrollIntoView({ behavior: 'smooth' })}
          >
            Our Edge
          </button>
          <button
        ...
        <div class="flex justify-center items-center gap-6 mb-8">
          ...
          <!-- LinkedIn icon -->
          <a
            href="https://linkedin.com/company/ekafrontier"
            target="_blank"
        ...
        <div class="text-center">
          <p class="text-sm text-gray-500">© 2025 Eka Frontier</p>
        </div>
      </div>
    </div>
  </div>
